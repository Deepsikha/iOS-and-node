...
var runExample = function () {
    ...
    var people = [];
    people.push({name:'name1', age:29, hasCar:true, optionalProperty:42, multiTypes:"aString", nested:{inner:'value'}})
    people.push({name:'name2', age:32, hasCar:true, multiTypes:33})
