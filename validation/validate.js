...
new User({name: "name", age:15}).validate(function (error) {
    console.log("ERROR: ", error); // Error for Age Field, age is less than Minimum value.
});
new User({name: "name", age:61}).validate(function (error) {
    console.log("ERROR: ", error); // Error for Age Field, age is more than Maximum value.
});
new User({name: "name", age:25, gender:"male"}).validate(function (error) {
    console.log("ERROR: ", error); // Error for Gender Field, male does not match with ENUM.
});
new User({name: "name", age:25, gender:"MALE", email:"lanet.milans@gmail.com"}).validate(function (error) {
    console.log("ERROR: ", error); // Error for Invalid Email id.
});
new User({name: "name", age:25, gender:"MALE", email:"lanet.milans@gmail.com.com"}).validate(function (error) {
